...
#if defined(CLIENT) || defined(EDITOR)
...
void Wall::GetScreenBounds(const glm::mat4 &view, const glm::mat4 &projection, float screenWidth, float screenHeight,
                           Vector2 &topLeft, Vector2 &bottomRight) const {
